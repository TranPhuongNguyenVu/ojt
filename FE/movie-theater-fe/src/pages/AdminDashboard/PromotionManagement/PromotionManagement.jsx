            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {isLoading ? (
                ...
                paginatedPromotions.map((promo) => (
                  <tr key={promo.promotionId} className="hover:bg-gray-50 dark:hover:bg-gray-800/60 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 bg-[#FFF0F2] dark:bg-red-950/40 rounded-lg flex items-center justify-center text-[#C00000] dark:text-red-300 shrink-0">
                          <Tag size={16} />
                        </div>
                        <div>
