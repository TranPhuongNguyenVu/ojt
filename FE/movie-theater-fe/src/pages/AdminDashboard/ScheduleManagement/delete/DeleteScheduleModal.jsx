    ...
    <ScheduleModalLayout title="Xóa suất chiếu" onClose={onClose}>
      <div className="p-6 space-y-4">
        <div className="flex flex-col items-center text-center gap-3">
          ...
          <div className="text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800/60 rounded-lg px-4 py-3 text-left w-full space-y-1">
          ...
          <p className="text-xs text-red-500 dark:text-red-400">Hành động này không thể hoàn tác.</p>
        </div>
