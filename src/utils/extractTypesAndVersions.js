/**
 * Tổng hợp danh sách Version từ toàn bộ phim đã load.
 * Workaround vì không dùng GET /api/versions (Type đã có GET /api/types riêng).
 * Chỉ trả về các version đã được gán cho ít nhất 1 phim.
 */
