                        ...
                        <td className={tdCls}>
                          <div className="flex items-center gap-3">
                            {admin.image ? (
                              ...
                              <div className="w-8 h-8 rounded-full bg-red-50 dark:bg-red-950/40 flex items-center justify-center text-[#C00000] dark:text-[#ff4d57] font-bold text-sm">
                                {admin.fullName?.[0] || "A"}
                              </div>
                            )}
                        ...
                        <td className={tdCls}>
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              title="Sửa thông tin"
                              className="p-1.5 rounded-md text-blue-500 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/40 hover:bg-blue-100 dark:hover:bg-blue-900/50 hover:text-blue-700 dark:hover:text-blue-300 transition-colors"
                            >
                              <Edit size={15} />
                            </button>
                            {/* Lock / Unlock */}
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-md text-[#C00000] dark:text-[#ff4d57] bg-red-50 dark:bg-red-950/40 hover:bg-red-100 dark:hover:bg-red-900/50 hover:text-[#a00000] dark:hover:text-[#ff6b73] transition-colors"
                            >
                              <RotateCcw size={15} />
                            </button>
                            {/* Delete */}
                            <button
                              ...
                              title="Xóa"
                              className="p-1.5 rounded-md text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-950/40 hover:bg-red-100 dark:hover:bg-red-900/50 hover:text-red-700 dark:hover:text-red-300 transition-colors"
                            >
                              <Trash2 size={15} />
                            </button>
                          </div>
