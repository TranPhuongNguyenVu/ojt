...
public class EmployeeService {
    ...
    public void resetPassword(String employeeId) {
        ...
        String tieuDe = "Khôi phục mật khẩu tài khoản nhân viên";
        String noiDung = "Chào " + account.getFullName() + ",\n\n"
                + "Yêu cầu khôi phục mật khẩu cho tài khoản nhân viên của bạn đã được thực hiện bởi Con Mèo.\n"
    ...
    public EmployeeDTO createEmployee(CreateEmployeeRequest request) {
        if (accountRepository.existsByUsername(request.getUsername().trim())) {
        ...
        String tieuDe = "Thông tin tài khoản nhân viên MTMS Cinema";
        String noiDung = "Chào " + request.getFullName().trim() + ",\n\n"
                + "Bạn đã được cấp tài khoản nhân viên tại hệ thống MTMS Cinema.\n"
