...
const QuickBookingBar = () => {
  ...
  // Chỉ hiển thị các phim đang có suất chiếu trong tương lai (BE đã lọc theo Schedule thực tế).
  useEffect(() => {
    MovieService.getMoviesWithShowtimes()
      .then((res) => {
  ...
  const handleBookTicket = () => {
    ...
    if (selectedDate && !selectedScheduleId) {
      newErrors.time = 'Vui lòng chọn suất chiếu';
      hasError = true;
    }
